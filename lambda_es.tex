...
\begin{coqdoccode}
\end{coqdoccode}
If \coqdocvar{t} is a variable, say \coqdocvar{z}, then we have that \coqdocvar{x'} \ensuremath{\not=} \coqdocvar{z} by hypothesis, and we conclude by lemma \coqdocvar{swap\_neq} \symbol{92}footnote\{\symbol{92}url\{https://github.com/flaviodemoura/lx\_confl/tree/m\_subst\_lemma\}\}.
\begin{coqdoccode}
\end{coqdoccode}
